      ...
      <section id="services" className="py-20 bg-secondary bg-pattern">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm service-card">
              ...
              <h3 className="text-xl font-bold mb-2 text-center text-primary">Диагностика</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm service-card">
              ...
              <h3 className="text-xl font-bold mb-2 text-center text-primary">Ремонт</h3>
              <div className="w-16 h-1 bg-accent/50 mx-auto mb-4"></div>
              <p className="text-gray-700 text-center">
